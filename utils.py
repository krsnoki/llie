...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, default='F:/kalyani/lol_dataset/train')
    parser.add_argument('--data_path_test', type=str, default='F:/kalyani/lol_dataset/test')
